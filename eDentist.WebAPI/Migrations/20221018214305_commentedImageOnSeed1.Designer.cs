...
namespace eDentist.WebAPI.Migrations
{
    ...
    [Migration("20221018214305_commentedImageOnSeed1")]
    partial class commentedImageOnSeed1
    {
            ...
            modelBuilder.Entity("eDentist.WebAPI.Database.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            CityId = 1,
                            DateOfBirth = new DateTime(2022, 10, 18, 23, 43, 4, 765, DateTimeKind.Local).AddTicks(2954),
                            Email = "emir.pajic@edu.fit.ba",
                            FirstName = "Emir",
                            LastName = "Pajić",
                            PasswordHash = "EwUxbmLdY00ZshWJifsAsbSnoJk=",
                            PasswordSalt = "wBZgEOMGDj5NXpuE5ALw5w==",
                        ...
                        new
                        {
                            UserId = 2,
                            CityId = 2,
                            DateOfBirth = new DateTime(2022, 10, 18, 23, 43, 4, 765, DateTimeKind.Local).AddTicks(3179),
                            Email = "emir.pajic2@edu.fit.ba",
                            FirstName = "Emir",
                            LastName = "Pajić",
                            PasswordHash = "YA3yXbmAa+H2BmbxNIS+KzJeukU=",
                            PasswordSalt = "x89s0avTH9+axiVN6Qsjpw==",
                            Telephone = "061-918-661",
                            Username = "Pajson2"
                        });
                });
