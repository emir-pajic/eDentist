...
namespace eDentist.WebAPI.Migrations
{
    ...
    [Migration("20221018210206_commentedImageOnSeed")]
    partial class commentedImageOnSeed
    {
            ...
            modelBuilder.Entity("eDentist.WebAPI.Database.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            CityId = 1,
                            DateOfBirth = new DateTime(2022, 10, 18, 23, 2, 5, 991, DateTimeKind.Local).AddTicks(9937),
                            Email = "emir.pajic@edu.fit.ba",
                            FirstName = "Emir",
                            LastName = "Pajić",
                            PasswordHash = "Xos/s1gaiHNyXBFI1JMSzSeVsNM=",
                            PasswordSalt = "h69/fPbMxz2hUO/VnQr7LQ==",
                        ...
                        new
                        {
                            UserId = 2,
                            CityId = 2,
                            DateOfBirth = new DateTime(2022, 10, 18, 23, 2, 5, 992, DateTimeKind.Local).AddTicks(144),
                            Email = "emir.pajic2@edu.fit.ba",
                            FirstName = "Emir",
                            LastName = "Pajić",
                            PasswordHash = "qbCA4TBYe09jV51KjL3sfBmJhS8=",
                            PasswordSalt = "z/qRcL22dB4Siv649lGLsw==",
                            Telephone = "061-918-661",
                            Username = "Pajson2"
                        });
                });
